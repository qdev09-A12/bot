...
isroom = False
isroom2 = False
paylod_token1 = ""
...
if __name__ == "__main__":
    if len(sys.argv) != 3:
        print("Làm Bot Thì Viết Code Bot Gọi Hàm Chạy Lệnh Này: python team.py uid-cần-mời số-team")
        sys.exit(1)
    try:
    ...
    try:
        client_thread = FF_CLIENT(
            id="4177697551",
            password="5F9780ED44F63EC8DC38C1E5E00A5CF0D7BB8230A1EAC90676D0D936CF83356A",
